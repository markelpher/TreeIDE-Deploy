...
- **Modelos personalizados** — criar em branco, importar do projeto atual, renomear, editar conteúdo de arquivos inline, abrir no editor principal, exportar ou excluir sem sair da tela
...
- **Abas de visualização de arquivos por projeto** — editar conteúdo de arquivos iniciais antes de construir
