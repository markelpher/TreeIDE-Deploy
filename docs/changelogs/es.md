...
- **Opciones explícitas de retención de datos** — la instalación manual sobre una versión existente de Tree IDE y la desinstalación ahora presentan opciones claras de Conservar o Eliminar, con Conservar seleccionada por defecto
...
- **Runtime de Windows x64 optimizado** — se eliminaron la herramienta de empaquetado Squirrel no utilizada y los binarios de 7-Zip no Windows/no x64 de los archivos de aplicación distribuidos
...
- **Panel de validación** — mala indentación, nombres inválidos, hermanos duplicados, rutas inseguras y estructuras vacías; haga clic en una advertencia para saltar a la línea
...
- **Paneles redimensionables** (editor, árbol, previsualización de archivos) con diseño persistente entre sesiones
...
- **Borrador de problema localizado limpio** — abrir GitHub automáticamente después de un retraso visible de redirección con el título, secciones de Markdown y etiqueta seleccionada ya completadas para revisión; haga clic en el aviso o presione Enter/Espacio para ocultar la notificación sin cambiar el temporizador, y el problema nunca se envía automáticamente
...
- **Adjuntos locales primero** — guardar el ZIP en la ruta elegida por el usuario sin abrir el Explorador de archivos o cargarlo; los registros y capturas de pantalla permanecen locales hasta que se adjuntan manualmente
- **Modal de informe más seguro** — la selección de texto y el arrastre ya no cierran el diálogo, los campos se redimensionan automáticamente, el contraste del tema claro/oscuro sigue el resto de la aplicación, y el formulario se restablece después de éxito, Cancelar o cerrar con el botón X
...
- **Suite de pruebas Vitest** con simulaciones de Electron para ejecuciones amigables con CI; los ayudantes de errores de registro de cambios y actualizador están cubiertos por pruebas dedicadas
