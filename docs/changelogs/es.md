...
- **Linux** — AppImage, deb y snap para x64 y ARM64; construcciones de Flatpak (x86_64 y aarch64, runtime 25.08) con lanzador `zypak-wrapper`
...
- **`semver`** como una dependencia directa para comparación de versiones confiable en la aplicación
