...
- **Salidas combinadas** — opcionalmente exportar un ZIP junto con una construcción de carpeta, e incluir el archivo `.tree` dentro del archivo comprimido
